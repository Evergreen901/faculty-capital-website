...
const InsightsSignUpCard = ({ type = 2 }) => {
    ...
    return (
        <div
            className={clsx(
                'insights-sign-up-card-container p-8 show-assets -mx-6 md:mx-0 md:rounded-[10px] md:border-solid md:border-[15px] md:border-[#333333b0]',
                type === 1
                    ? 'col-span-1 md:after:hidden md:before:hidden'
                    : 'col-span-2 md:py-12 md:pl-12 md:pr-40 md:before:!top-[unset] md:before:!bottom-[-10%] md:before:!w-[210px] md:before:!h-[240px] md:after:!top-[-3%] md:after:!w-[260px] md:after:!h-[260px] '
            )}
        >
            <div className="flex item-center">
                <span
                    className={clsx(
                        'font-bold text-white text-[28px] leading-[37px] -tracking-[0.7px]',
                        type === 1 ? '' : 'md:text-[36px] md:leading-[50px] md:-tracking-[0.9px]'
                    )}
                    ref={ref}
                />
            </div>
            <p className="text-white text-[14px] leading-[25px] -tracking-[0.35px]">{t('insights.description')}</p>
