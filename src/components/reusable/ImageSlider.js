                    ...
                    >
                        ...
                        {!isStory && (
                            <div className="absolute left-[10%] right-[10%] top-[10%] flex items-center justify-end">
                                ...
                                <span
                                    className={clsx(
                                        'font-bold text-[10px] text-white leading-[21px] tracking-[1px] bg-origin-padding bg-no-repeat rounded-[2px] px-6 py-1',
                                        item.tags.includes(BLOG_TAG_TYPE.PODCAST) ? 'bg-[#E55800]' : 'bg-[#0000FF]'
                                    )}
                                >
